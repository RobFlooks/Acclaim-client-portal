              ...
              {messagesLoading ? (
                ...
                <div className="space-y-4">
                  {recentMessages.map((message: any) => (
                    ...
                    >
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center overflow-hidden ${message.senderIsAdmin ? 'bg-white border-2 border-acclaim-teal' : 'bg-white border-2 border-rose-300'}`}>
